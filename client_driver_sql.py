# client.py - CLIENT SIDE (Driver - Luqman's Part)
"""
CLIENT SIDE - Driver Application
This runs on the driver's device (Luqman's computer)
Connects to the server to get deliveries and update status
"""
...
class DriverClient:
    ...
    def __init__(self, host='10.68.170.11', port=5000):
        """
...
if __name__ == "__main__":
    ...
    SERVER_HOST = '10.68.170.11'  # Change to server IP if on different computer
    SERVER_PORT = 5000
