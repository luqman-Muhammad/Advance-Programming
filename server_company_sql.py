# server_sql.py - SERVER SIDE (Company/Admin) - SQL VERSION
"""
SERVER SIDE - Courier Service Management System
This runs on the company's computer
Handles all administrative operations and serves client requests
NOW USING SQL DATABASE instead of flat files
"""
...
if __name__ == "__main__":
    ...
    server = CourierServer(host='localhost', port=5555)
